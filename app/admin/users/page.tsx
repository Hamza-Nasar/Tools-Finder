  ...
  try {
    ...
    return (
      <EmptyState
        ...
        description="MongoDB could not be reached, so the admin user list cannot load right now. Check the Atlas connection or network DNS and refresh."
        ctaHref="/admin"
        ctaLabel="Back to admin overview"
      />
    );
  }
}
