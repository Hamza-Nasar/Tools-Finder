        ...
        <DialogContent className="max-w-md">
          <DialogHeader>
            <DialogTitle className="flex items-center gap-2">
              ...
              {state.status === "success" ? "Submission sent" : "Please review the form"}
            </DialogTitle>
            <DialogDescription>
              {state.message ??
                (state.status === "success"
                  ? "Your submission has been added to the moderation queue."
                  : "There are validation errors in your submission.")}
            </DialogDescription>
          </DialogHeader>
          <DialogFooter>
            <Button type="button" onClick={() => setIsFeedbackDialogOpen(false)}>
              OK
            </Button>
          </DialogFooter>
        </DialogContent>
        ...
        <CardContent className="pt-6">
          ...
          <div className="surface-subtle p-5">
            ...
            <div className="mt-6 space-y-2">
              ...
              <Input
                id="tagline"
                name="tagline"
                placeholder="Describe the core value in one strong sentence."
            ...
            <div className="grid gap-6 md:grid-cols-3">
              ...
              <div className="space-y-2">
                ...
                <Input
                  id="tags"
                  name="tags"
                  placeholder="automation, video, editing"
          ...
          <div className="hidden">
            ...
            <Input
              ...
              autoComplete="off"
              aria-hidden="true"
              value={formValues.websiteConfirm}
              onChange={(event) => updateField("websiteConfirm", event.target.value)}
            />
          </div>
