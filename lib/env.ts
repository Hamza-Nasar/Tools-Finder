...
const envSchema = z.object({
  ...
  STRIPE_VENDOR_MONTHLY_PRICE_ID: optionalString,
  STRIPE_VENDOR_YEARLY_PRICE_ID: optionalString,
  RESEND_API_KEY: optionalString,
  EMAIL_FROM: optionalString,
  NEXT_PUBLIC_EMAILJS_TEMPLATE_ID: optionalString,
  NEXT_PUBLIC_EMAILJS_SERVICE_ID: optionalString,
  NEXT_PUBLIC_EMAILJS_PUBLIC_KEY: optionalString,
...
export const env = envSchema.parse({
  ...
  STRIPE_VENDOR_MONTHLY_PRICE_ID: process.env.STRIPE_VENDOR_MONTHLY_PRICE_ID,
  STRIPE_VENDOR_YEARLY_PRICE_ID: process.env.STRIPE_VENDOR_YEARLY_PRICE_ID,
